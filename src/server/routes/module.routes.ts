...
const availableModules = [
  ...
  { key: "marketplace", name: "Marketplace odontologico", description: "Vitrine para servicos, compras e vendas exclusivamente relacionados a odontologia, com solicitacao de orcamento sem pagamento direto no MVP.", category: "ADMINISTRATIVE", basePrice: 59.9, scope: "COMMON", specialtyKey: null, specialtyName: null },
